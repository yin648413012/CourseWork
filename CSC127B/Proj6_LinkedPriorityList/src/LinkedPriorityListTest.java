...
public class LinkedPriorityListTest {
	...
	public void testRemoveInMiddle() {
		...
		assertEquals("seven", list.getElementAt(0));
		assertEquals("six", list.getElementAt(1));
		assertEquals("five", list.getElementAt(2));
		assertEquals("four", list.getElementAt(3));
		assertEquals("two", list.getElementAt(4));
		assertEquals("one", list.getElementAt(5));
	}

	@Test
	public void testRaisePriorityInMiddle() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "one");
		list.insertElementAt(1, "two");
		list.insertElementAt(2, "three");
		list.insertElementAt(3, "four");
		list.insertElementAt(4, "five");
		list.insertElementAt(5, "six");
		list.insertElementAt(6, "seven");
		list.raisePriorityOf(4);
		assertEquals("seven", list.getElementAt(6));
		assertEquals("six", list.getElementAt(5));
		assertEquals("four", list.getElementAt(4));
		assertEquals("five", list.getElementAt(3));
	...
	@Test
	public void testRemovingElements2() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Truck");
		list.insertElementAt(0, "Stone");
		list.insertElementAt(0, "Lost");
	...
	public void testGetElement() {
		...
		// assertEquals("A B C", list.toString().trim());
	...
	@Test
	public void testLowerPriorityOfLastIndex() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Bob");
		list.insertElementAt(1, "Chris");
		list.insertElementAt(2, "Dylan");
		...
		assertEquals("Chris", list.getElementAt(1));
		assertEquals("Dylan", list.getElementAt(2));
	}

	@Test
	public void testRaisePriorityOfIndex2WithSize3() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Bob");
		list.insertElementAt(1, "Chris");
		list.insertElementAt(2, "Dylan");
	...
	@Test(expected = IllegalArgumentException.class)
	public void testThrowExceptionAtRemoveElementAt2() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test(expected = IllegalArgumentException.class)
	public void testThrowExceptionAtMoveToTop2() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test(expected = IllegalArgumentException.class)
	public void testThrowExceptionAtMoveToLast2() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test
	public void testRegCaseMoveToTop() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
		list.insertElementAt(3, "Small");
		list.moveToTop(1);
		assertEquals("Break", list.getElementAt(0));
		assertEquals("Tuna", list.getElementAt(1));
		assertEquals("Milk", list.getElementAt(2));
		assertEquals("Small", list.getElementAt(3));
	}

	@Test
	public void testMoveToTopAtIndex0() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
		...
		list.moveToTop(0);
		assertEquals("Tuna", list.getElementAt(0));
		assertEquals("Break", list.getElementAt(1));
		assertEquals("Milk", list.getElementAt(2));
		assertEquals("Small", list.getElementAt(3));
	}

	@Test
	public void testMoveToLastAtLastIndex() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	public void testMoveToLastx() {
		...
		assertEquals("Break", list.getElementAt(1));
		assertEquals("Small", list.getElementAt(2));
		assertEquals("Milk", list.getElementAt(3));
		...
		list.moveToLast(0);
		assertEquals("Small", list.getElementAt(0));
		assertEquals("Milk", list.getElementAt(1));
		assertEquals("Break", list.getElementAt(2));
		assertEquals("Tuna", list.getElementAt(3));
	}
	...
	public void testMoveToTop() {
		...
		assertEquals("Milk", list.getElementAt(0));
		assertEquals("Break", list.getElementAt(1));
		assertEquals("Tuna", list.getElementAt(2));
		assertEquals("Small", list.getElementAt(3));
	...
	@Test
	public void testMoveToLastAtIndexSecondToLastIndex() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test
	public void testMoveToTopAtIndex1() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test
	public void testSpecCaseMoveToTop() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test
	public void testRaisePriorityOfIndexZero() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
	...
	@Test
	public void testLowerPriorityOfIndexZero() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		list.insertElementAt(0, "Tuna");
		list.insertElementAt(1, "Break");
		list.insertElementAt(2, "Milk");
